        ...
        <div class="row g-3">
          <div class="col-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control inputs" name="title" placeholder="Tên bài viết" value="{{ $data->title }}">
            </div>
          </div>
          <div class="col-6">
            <div class="mb-3">
              <label class="form-label">Thẻ tiêu đề</label>
              <input type="text" class="form-control" name="title_tag" value="{{ $data->title_tag }}">
            </div>
          </div>
          <div class="col-6">
            <div class="mb-3">
              ...
              <label>Danh mục <small class="label bg-red">Bắt buộc</small></label>
              <input type="text" id="title" class="form-control" name="slug" placeholder="ten-bai-viet" value="{{ $data->slug }}">
            </div>
          </div>
          <div class="col-6">
            <div class="mb-3">
          ...
          <div class="col-6">
            <div class="mb-3">
              ...
              <textarea rows="3" class="intro-count form-control" data-max-length="200" name="intro" placeholder="" maxlength="250">{{ $data->intro }}</textarea>
            </div>
          </div>
          <div class="col-12">
            <div class="mb-3">
              <label class="form-label">Giới thiệu ngắn</label>
              <textarea rows="30" class="intro-count form-control" id="tiny" name="content">{{ $data->content }}</textarea>
            </div>
          </div>
        </div>
      </div>
