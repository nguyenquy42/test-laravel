              ...
              <div class="product_item_content">
                ...
                <div class="list_price_cart">
                  ...
                  <ul class="m-0 none-list-type product-cart">
                    <li class="product_cart_item"><a href="#"><i class="far fa-heart"></i></a></li>
              ...
              <div class="blog_item_content">
                ...
                <div class="list_author_date">
                  <ul class="none-list-type blog_item_author_date">
                    ...
                    <li class="blog_item_ad"><a href="#"><i class="far fa-calendar-minus" aria-hidden="true"></i>{{ $item->date }} </a></li>
                  </ul>
                </div>
              </div>
            </div>
